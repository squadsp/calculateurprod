...
import { FileUp, Loader2, AlertCircle, Download, X, Printer } from "lucide-react";
import { processPortesPdf, type PortesKeywords } from "@/lib/portesProcessor";
...
export function PortesCalculator({
  title,
  subtitle,
  storageKey,
  defaultKeywords,
